                   ...
                   tabPanel("Time Series",
                            tabsetPanel(
                              tabPanel("Visualization",
                                       sidebarLayout(
                                         sidebarPanel(
                                           selectInput(inputId="Allusset", label="Time column", choices = c("batch", "condition")),
                                           numericInput(inputId="Allussize", label="Sample Size (to rarefaction)", min = 1, value = 1000),
                                           uiOutput("Alluglom"),
                                           uiOutput("Allustax")
